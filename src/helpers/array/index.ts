 ...
 */
export const insertIntoArray = <T extends Array<Y>, Y>(array: T[], index: number, item: T) => [
  ...array.slice(0, index),
  item,
 ...
 */
export const replaceIntoArray = <T extends Array<Y>, Y>(array: T[], index: number, item: T) => [
  ...array.slice(0, index),
  item,
